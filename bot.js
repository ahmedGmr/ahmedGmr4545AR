...
client.user.setGame(`TOP$TOB$`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
كود الرابع*
كود هيلب
1-كود هيلب مزخرف وحلو وتجيك رسالة على خاص
client.on('message', message => {
...
Server support:https://discord.gg/fsa3sV

==================================================================

bot invite link: https://discordapp.com/api/oauth2/authorize?client_id=471531013193859072&permissions=0&redirect_uri=https%3A%2F%2Fdiscord.gg%2F5amSGB&scope=bot
